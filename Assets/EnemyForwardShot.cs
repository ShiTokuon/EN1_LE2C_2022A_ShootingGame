...
public class EnemyForwardShot : MonoBehaviour
{
    ...
    private void CreateShotObject(float axis)
    {
        ...
        var bulletObuject = bulletClone.GetComponent<EnemyBullet>();

        //弾を打ち出したオブジェクトの情報を渡す
        bulletObuject.SetCharacterObject(gameObject);

        //弾を打ち出す角度を変更する
        bulletObuject.SetForwardAxis(lookRotation * Quaternion.AngleAxis(axis, Vector3.up));
    }
}
